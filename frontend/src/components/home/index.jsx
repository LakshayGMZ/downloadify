...
function IndexPage() {
  ...
  function onSearchClick(event) {
    ...
    if (inputValue.startsWith("https://www.youtube.com/watch?v=")) {
      var parsedURL = new URLSearchParams(
    ...
    <div>
      ...
      <div className="features">
        ...
        <div className="row">
          ...
          <div className="text-col">
            <h2>STEP2.</h2>
            <p className="steps-parra">
              Copy YouTube video link and paste it to Downlodify YouTube Videos
              Downloader.
            </p>
          </div>
        </div>
        <div className="row">
          <div className="text-col">
            <h2>STEP3.</h2>
            <p className="steps-parra">
              Download YouTube HD video to MP4 with simple click.
            </p>
          </div>
          <div className="img-col">
